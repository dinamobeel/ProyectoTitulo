...
<div class="container">
    <h2>Lista de Recetas - Módulo A</h2>

    <table class="table table-bordered" id="recetas-table-a">
        <thead>
            <tr>
                <th>ID</th>
                <th>Paciente</th>
...
<script type="text/javascript">
    $(function() {
        $('#recetas-table-a').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('/farmaceutico/moduloA') }}",
            columns: [
