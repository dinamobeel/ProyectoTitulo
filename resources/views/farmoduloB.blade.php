...
<div class="container">
    <h2>Lista de Recetas - Módulo B</h2>

    <table class="table table-bordered" id="recetas-table-b">
        <thead>
            <tr>
                <th>ID</th>
                <th>Paciente</th>
...
<script type="text/javascript">
    $(function() {
        $('#recetas-table-b').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('/farmaceutico/moduloB') }}",
            columns: [
